...
$archivosSql = [
    ...
    '../php/duenoLocal/savePromociones.php',
    '../php/loginUser.php',
    ...
    '../php/duenoLocal/aprobarSolicitudDescuentoCliente.php',
    '../php/duenoLocal/DenegarSolicitudDescuentoCliente.php',
    '../php/cliente/utilizarDescuento.php',
    '../php/duenoLocal/reporteDescuento.php',
    '../php/duenoLocal/listaSolicitudDescuentos.php',
