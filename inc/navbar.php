...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <div class="container">
        <a class="navbar-brand" href="index.php"><span class="text-warning">NO</span>VA</a>
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
                <a class="nav-link" href="index.php?vista=home">INICIO</a>
            </li>
<?php
    if((!isset($_SESSION['codUsuario']) || $_SESSION['codUsuario']=="") || (!isset($_SESSION['nombreUsuario']) || $_SESSION['nombreUsuario']=="")){
        echo '<li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?vista=login">INICIAR SESIÓN</a>
            </li>';
    } else{
        if($_SESSION['tipoUsuario']=="Administrador"){
                echo '<li class="nav-item">
                    <a class="nav-link" href="index.php?vista=localsList">Gestionar Locales</a>
                </li>
            ...
            if($_SESSION['tipoUsuario']=="Cliente") {
                echo '<li class="nav-item">
                    ...
                    echo '<li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?vista=discountReport">Usos de Descuento</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?vista=novedadesList">Novedades</a>
                        </li>
