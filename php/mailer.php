...
/* Envía un correo con enlace de verificación de email.
 * 
 * @param string $emailDestinatario correo del usuario
 * @param string $tipoUsuario tipo de cuenta (Cliente / Dueño)
...
function enviarCorreoVerificacion(string $emailDestinatario, string $tipoUsuario, string $enlaceVerificacion): bool {
    try {
        ...
        $mail->Subject = 'Verificá tu email — NovaShopping';
        $mail->Body    = '
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px; overflow: hidden;">
            <div style="background-color: #212529; padding: 20px; text-align: center;">
                <h1 style="color: #e0a800; margin: 0; font-size: 24px;">NovaShopping</h1>
            ...
            <div style="padding: 30px;">
                <h2 style="color: #212529; margin-top: 0;">Verificá tu dirección de email</h2>
                <p style="color: #495057; line-height: 1.6;">
                    Gracias por registrarte en <strong>NovaShopping</strong>. Para activar tu cuenta, hacé clic en el siguiente botón:
                </p>
                <div style="text-align: center; margin: 30px 0;">
                    <a href="' . htmlspecialchars($enlaceVerificacion) . '" 
                       style="background-color: #0d6efd; color: #ffffff; text-decoration: none; padding: 14px 30px; border-radius: 50px; font-size: 16px; font-weight: bold; display: inline-block;">
                        Verificar mi email
                    </a>
                </div>
                ...
                <div style="background-color: #fff3cd; border: 1px solid #ffc107; border-radius: 4px; padding: 15px; margin: 20px 0;">
                    <p style="color: #856404; margin: 0; font-size: 13px;">
                        <strong>⏳ Este enlace expira en 24 horas.</strong> Si no verificás tu email a tiempo, deberás registrarte nuevamente.
                    </p>
                </div>
                <p style="color: #6c757d; font-size: 14px; margin-top: 20px;">
